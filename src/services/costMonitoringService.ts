...
export class CostMonitoringService {
  ...
  async getAllCosts(): Promise<CostData[]> {
    ...
    // NOTE: OpenAI cost monitoring removed - OpenAI does not provide actual billing/cost data via API
    // Only usage data is available, which would require manual cost calculation and maintenance
    // This is not reliable for automated cost monitoring
